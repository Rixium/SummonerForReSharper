...
namespace JetBrains.Rider.Model
{
  ...
  /// <summary>
  /// <p>Generated from: SummonerModel.kt:8</p>
  /// </summary>
  public class SummonerModel : RdExtBase
  {
    //fields
    //public fields
    ...
    protected override long SerializationHash => 3773160216162741667L;
  ...
  public static class SolutionSummonerModelEx
   {
    public static SummonerModel GetSummonerModel(this Solution solution)
    {
      return solution.GetOrCreateExtension("summonerModel", () => new SummonerModel());
    }
  }
  
  
  /// <summary>
  /// <p>Generated from: SummonerModel.kt:10</p>
  /// </summary>
  public enum MyEnum {
    FirstValue,
    SecondValue
  ...
  /// <summary>
  /// <p>Generated from: SummonerModel.kt:15</p>
  /// </summary>
